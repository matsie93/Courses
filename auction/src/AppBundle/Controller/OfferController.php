        ...
        if($bidForm->isValid()){
            ...
            if(isset($lastOffer)){
                ...
                if($offer->getPrice() <$auction->getStartingPrice()){
                    $this->addFlash("error","Twoja oferta musi być większa od wywoławczej");
                    return $this->redirectToRoute("auction_details", ["id" => $auction->getId()]);
                }
            }
            ...
            $this->addFlash("success","Złożyłeś ofertę za przedmiot {$auction->getTitle()} za kwotę {$offer->getPrice()}zł.");
        }
        else{
